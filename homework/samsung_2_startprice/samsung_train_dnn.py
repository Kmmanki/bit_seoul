...
sam_dense = Conv1D(500, 3, activation='relu')(sam_input)
...
bit_dense = Conv1D(50, activation='relu')(bit_dense)
bit_dense = Dense(10, activation='relu')(bit_dense)

kosdak_input = Input(shape=(35))
kosdak_dense = Conv1D(50, activation='relu')(kosdak_input)
kosdak_dense = Dense(30, activation='relu')(kosdak_dense)
kosdak_dense = Dense(10, activation='relu')(kosdak_dense)

gold_input = Input(shape=(30))
gold_dense = Conv1D(50, activation='relu')(gold_input)
gold_dense = Dense(30, activation='relu')(gold_dense)
