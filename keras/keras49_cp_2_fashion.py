...
#2. 모델링 Conv2D
model = Sequential()
model.add(Conv2D(100, (2,2), input_shape=(28,28,color)))
...
modelPath = './save/fashion/keras49_cp_2_fashion_cnn{epoch:02d}--{val_loss:.4f}.hdf5'
checkPoint = ModelCheckpoint(filepath=modelPath, monitor='val_loss', save_best_only=True, mode='auto' )

hist=model.fit(x_train, y_train, epochs=200, batch_size=64, validation_split=0.2, callbacks=[ealystopping, 
# to_hist
checkPoint])
