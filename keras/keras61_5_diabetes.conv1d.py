...
x = dataset.data.reshape(442,10,1)
y = dataset.target
...
model = Sequential() #r2 = 
model.add(Conv1D(10, 3,activation='relu', input_shape=(10,1)))
model.add(Flatten())
...
'''
Conv1D
loss:  [4809.7626953125, 53.46946716308594]
RMSE 73.94927023346756
R2:  -0.6662892060741568
정답:  [168. 192. 102. 142.  66. 104. 246. 113. 111.  42.]
예측:  [[ 70.643135]
 [196.31013 ]
 [209.72386 ]
 [104.3917  ]
