...
model.add(Dropout(0.2))  
model.add(Conv2D(100, (3,3), strides=2)) 
model.add(Dropout(0.2))  
...
hist = model.fit(x_train, y_train, validation_split=0.2, epochs=100, batch_size=128, verbose=1, callbacks=[earlyStopping, to_hist])
