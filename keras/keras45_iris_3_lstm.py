...
hist = model.fit(x_train, y_train, epochs=300, batch_size=4, validation_split=0.2, callbacks=[ealystopping, to_hist])
...
'''
acc 1.0
loss 0.014464199542999268
정답 [1 0 0 2 1 1 2 1 0 1]
예상값 [1 0 0 2 1 1 2 1 0 1]
'''