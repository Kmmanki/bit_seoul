...
from tensorflow.keras.layers import Dense, Conv1D, LSTM, Flatten, MaxPooling1D,Dropout
...
# model = Sequential()
# model.add(Conv1D(100, (2,2), input_shape=(32,32,3)))
# model.add(Flatten())
# model.add(Dense(100, activation='relu'))
# model.add(Dense(10, activation='softmax'))

model = Sequential()
model.add(Conv1D(32, 3, padding="same", input_shape=(32,32,3)))
