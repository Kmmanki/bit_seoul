...
2. np to pandas
3. pandas를 csv로 save
4. 읽은 csv 파일을 슬라이싱 하여 x와 y 분리
'''
#1.
data = np.loadtxt('.\data\csv\iris_ys2.csv', delimiter=',')

#2.
pandasData = pd.DataFrame(data)

#3.
pandasData.to_csv('data\csv\iris_ys2_pd.csv') # to_json도 있다.

#4.
x = pandasData[range(4)].to_numpy()
y = pandasData[4].values
